...
class PNANet(nn.Module):
    ...
    def __init__(self, num_feats):
        ...
        self.conv1 = PNAConv(num_feats, 32,['mean', 'max', 'sum'], ['identity', 'amplification'], 2.5)   #在linux 下不能使用 max
        self.conv2 = PNAConv(32, 20,['mean', 'max', 'sum'], ['identity', 'amplification'], 2.5)
